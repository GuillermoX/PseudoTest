...
public enum Types {
    ...
    public static Types getType(String type){
        if(type.compareToIgnoreCase("enter") == 0) return Types.INT;
        else if(type.compareToIgnoreCase("real") == 0) return Types.FLOAT;
        else if(type.compareToIgnoreCase("caracter") == 0 ||
                type.compareToIgnoreCase("caràcter") == 0) return Types.CHAR;
